...
const rebuildGeometryCli = evaluation.rebuildGeometryCli;
const registerAllExtensions = io.registerAllExtensions;
 ...
 */
export function generateOutputData(source, params, options) {
  const defaults = {
